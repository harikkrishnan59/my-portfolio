        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10">
              ...
              <p className="text-base md:text-lg text-gray-300/90 leading-relaxed">{project.Description || "No description available for this project."}</p>
              <ProjectStats project={project} />
              
              {/* MODIFICATION: The div containing the Live Demo and Github buttons has been removed. */}
            ...
            <div className="space-y-6 md:space-y-10">
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                <h3 className="text-xl font-semibold text-white/90 flex items-center gap-3"><Star className="w-5 h-5 text-yellow-400 group-hover:rotate-[20deg] transition-transform duration-300" />Key Features</h3>
